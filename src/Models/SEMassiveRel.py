...
#from src.EoMsANDFunctions.SchwingerEoMs_Massive import *    #cdv
from src.EoMsANDFunctions.SchwingerEoMs import *            # relativistic EoS
...
from src.EoMsANDFunctions.Conductivities_Massive import *   #cdv
...
modelSettings = {"pic": "mixed", "mF": 0, "geff": 0.1}    #cdv

def DefineConductivity(settings):
    def CollinearConductivity(frac):
        def conductivity(a, H, E, B, G, H0, mF, geff):
            return ComputeSigmaCollinear(a, H, E, B, G, frac, H0, mF, geff) #cdv
        return conductivity
